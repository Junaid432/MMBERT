...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_layers', type=int, default=4, help='num of heads in multihead attention')
    parser.add_argument('--heads', type=int, default=12, help='num of BERT layers')
    ...
    # Update paths with the correct image directories
    ...
    test_path = '/content/drive/MyDrive/ImageCLEF VQA-Med-2019/clef2019/ImageClef-2019-VQA-Med-Test/Test_images'
    ...
    best_loss = scheduler.best if args.resume else np.inf
